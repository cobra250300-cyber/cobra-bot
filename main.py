...
DEVELOPER_ID = 123456789  # ⚠️ غيّر هذا الرقم إلى معرفك
...
1. احفظ الكود في ملف مثلاً cobra_bot.py
2. غير DEVELOPER_ID في السطر 31 إلى معرف تليجرام الخاص بك
3. شغل البوت:
...
· ❌ رفع هذا الكود على GitHub
· ❌ إرساله لأي شخص
· ❌ مشاركة شاشتك والتوكن ظاهر
· ❌ استخدامه على سيرفر عام

للاستخدام الآمن في المستقبل، تعلم استخدام متغيرات البيئة:

```python
import os
TOKEN = 8287417165:AAHPHSh-WE6kIuy-Ueoo4QbQA7IP41oTKx4

البوت الآن جاهز للتشغيل المحلي! 🚀
